...
cl = [['dortmund'],['paris', 'saint', 'germain', 'psg'],[2, 'real', 'madrid'],[2, 'manchester', 'city', 'man'],['atalanta', 'bergamo'],['valencia'],['atlético', 'atletico'],['liverpool'],['chelsea'],['bayern', 'münchen', 'munchen', 'munich'],['olympique', 'lyon'],['juventus', 'turin', 'juve'],['tottenham', 'hotspur', 'spurs'],['leipzig'],['ssc', 'neapel', 'napoli'],['barcelona','barca']]
